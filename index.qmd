...
Word-by-word reveal effects for text and headers.

[View Example](examples/words.html){.btn .btn-primary}
[Source Code](https://github.com/EmilHvitfeldt/quarto-revealjs-more-fragments/blob/main/examples/words.qmd){.btn .btn-secondary}

<iframe src="examples/words.html" width="100%" height="500" style="border: 1px solid #ccc; border-radius: 4px;"></iframe>
